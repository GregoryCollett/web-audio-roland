...
- **AudioWorklets** — custom diode ladder (303) and IR3109 OTA ladder (GC-2) filter processors running on the audio thread
...
|-----|--------|
| `Space` | Play / Stop |
| `Tab` | Switch focus between GC-909, GC-303, GC-2 |
| `1`-`9`, `0`, `-` | Select drum instrument (when 909 focused) |
| `←` / `→` | Navigate steps |
| `↑` / `↓` | BPM ±1 (909) / Pitch ±1 semitone (303/GC-2) |
| `Cmd+↑` / `Cmd+↓` | Shuffle ±5% |
| `P` | Toggle drum step (909) |
| `A` | Toggle accent |
| `S` | Toggle slide (303/GC-2) |
| `N` / `R` / `T` | Set gate: Note / Rest / Tie (303/GC-2) |
